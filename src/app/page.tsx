...
export default function Home() {
  ...
  useEffect(() => {
    ...
    async function loadUser() {
      ...
      console.log("ANA SAYFA SESSION:", session);
      ...
      console.log("ANA SAYFA PROFILE ERROR:", error);
      ...
      // -------------------------------------------------
      // SESSION VAR AMA PROFILE BULUNAMADI
      // -------------------------------------------------
      // Kullanıcı yine de giriş yapmış kabul edilecek.
    ...
    const {
      ...
      (event, session) => {
        ...
        console.log(
          "ANA SAYFA AUTH EVENT:",
          event
        );

        console.log(
          "ANA SAYFA AUTH SESSION:",
          session
        );
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-zinc-400">
              Ekşi Kitap Kulübü İzmir olarak
