      ...
      <div className="relative z-10 w-full max-w-md bg-zinc-900/85 border border-zinc-800/80 p-8 rounded-3xl shadow-2xl backdrop-blur-md">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-emerald-400 tracking-wide">
            Ekşi Kitap Kulübü İzmir
          </h1>
          <p className="text-xs text-zinc-400 mt-2 leading-relaxed">
            Sisteme güvenli bir şekilde erişmek için Google hesabınızı kullanın. <br />
            <span className="text-emerald-300 font-medium">Not: Profil tamamlama işlemleri sadece ilk girişinize mahsustur, sonrasında bir daha sorulmaz.</span>
          </p>
        </div>
        ...
        <div className="space-y-4">
          <button
            ...
            type="button"
            className="w-full bg-white hover:bg-zinc-100 text-zinc-900 transition py-3.5 rounded-xl font-semibold text-sm flex items-center justify-center gap-3 shadow-lg cursor-pointer"
          >
